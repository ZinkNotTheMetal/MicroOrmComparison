...
namespace EntityFramework.DataLayer.Tests
{
    [TestFixture]
    public class EntityFrameworkRepositoryTests
    {
        ...
        public void ShouldReturnCorrectCountFromDatabase()
        {
            ...
            var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["EmployeeDBTest"].ConnectionString);
            conn.Open();
        ...
        [Test]
        //fix this test still
        //add tests for changing and saving department
        //add to other tests
